...
public class Hangman {
    ...
    public String selectSecret(int category) {
        ...
        String[] phrasesArr = {"HOW DO YOU DO", "A STRANGE TURN OF EVENTS", "THE END IS NIGH",
                               "I LOVE YOU", "I WILL DESTROY YOU", "MY HOUSE IS BURNING DOWN", 
                               "I SET MY GRANDMA ON FIRE", "PLEASE", "I YEARN FOR THE RESPECT OF MY FATHER", 
                               "CAN YOU PLEASE TOUCH ME", "THATS ONE SMALL STEP FOR MAN", "I CANNOT BELIEVE YOU DONE THAT",
                               "MY MOTHER NEVER VISITS", "MY GRANDMA SOURED", "I WOULD LIKE TO SPEAK TO YOUR MANAGER",
                               "IF THE SHOE FITS", "I DID NOT HIT HER", "YEET",};
